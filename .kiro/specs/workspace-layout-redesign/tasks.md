...
- [x] 11. 实现文件快速搜索
  - [x] 11.1 创建 `QuickOpen` 弹窗组件
  - [x] 11.2 实现文件模糊匹配算法
  - [x] 11.3 添加最近文件记录
  - [x] 11.4 实现键盘导航

- [x] 12. 实现内容搜索面板
  - [x] 12.1 创建 `SearchPanel` 组件
  - [x] 12.2 实现后端搜索 API 调用
  - [x] 12.3 添加正则表达式支持
  - [x] 12.4 实现搜索结果高亮显示
...
- [x] 13. 实现快捷键管理
  - [x] 13.1 创建 `useWorkspaceKeyboard` Hook
  - [x] 13.2 注册所有快捷键绑定
  - [x] 13.3 处理快捷键冲突
  - [x] 13.4 添加快捷键提示显示
